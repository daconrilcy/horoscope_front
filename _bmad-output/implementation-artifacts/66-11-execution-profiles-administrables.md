...
- [ ] Créer `ProviderParameterMapper` (scope minimal OpenAI, extensible 66.18) (AC: 1)
  ...
  - [ ] Implémenter `resolve_verbosity_instruction(verbosity_profile: VerbosityProfile) -> tuple[str, Optional[int]]` — retourne (instruction_text, recommended_max_tokens_or_None) (M1 fix)
