...
- frontend/src/tests/geocodingApi.test.ts (nouveau — 15 tests unitaires geocodeCity : succès, URL, encodage accents/apostrophes/umlauts/japonais, not-found, erreurs, NaN validation)
