...
| 2026-04-05 | Hardening runtime natal: les interprétations complètes vides sont désormais rejetées à la génération (`empty complete interpretation`), nettoyées à la lecture/liste si elles existent déjà en base, puis ignorées par l'UI. Ce nettoyage empêche qu'une entrée vide soit comptée comme interprétation complète réelle dans le parcours Basic/Premium. | Codex |
