# Execution Brief — CS-439-supprimer-adaptateurs-front-legacy-interpretation-natale

## Primary objective

Implement story `CS-439-supprimer-adaptateurs-front-legacy-interpretation-natale` exactly as defined in `../00-story.md`.
