# Execution Brief — cs-342-preuve-finale-evidence-hors-prompt-redaction-llm-natal

## Primary objective

Implement story `cs-342-preuve-finale-evidence-hors-prompt-redaction-llm-natal` exactly as defined in `../00-story.md`.
