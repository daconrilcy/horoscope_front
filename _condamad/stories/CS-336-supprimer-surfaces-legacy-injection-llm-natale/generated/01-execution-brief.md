# Execution Brief — cs-336-supprimer-surfaces-legacy-injection-llm-natale

## Primary objective

Implement story `cs-336-supprimer-surfaces-legacy-injection-llm-natale` exactly as defined in `../00-story.md`.
