# Execution Brief — CS-371-generer-exemples-json-theme-astral-llm-v1-par-plan

## Primary objective

Implement story `CS-371-generer-exemples-json-theme-astral-llm-v1-par-plan` exactly as defined in `../00-story.md`.
