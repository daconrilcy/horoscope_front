# Execution Brief — cs-166-calculer-aspects-dominants-et-socle-synastrie

## Primary objective

Implement story `cs-166-calculer-aspects-dominants-et-socle-synastrie` exactly as defined in `../00-story.md`.
