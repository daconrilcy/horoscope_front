# Execution Brief — cs-008-classer-reduire-compatibilites-legacy-prediction

## Primary objective

Implement story `cs-008-classer-reduire-compatibilites-legacy-prediction` exactly as defined in `../00-story.md`.
