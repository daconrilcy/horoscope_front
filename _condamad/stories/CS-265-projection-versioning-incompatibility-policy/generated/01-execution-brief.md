# Execution Brief — cs-265-projection-versioning-incompatibility-policy

## Primary objective

Implement story `cs-265-projection-versioning-incompatibility-policy` exactly as defined in `../00-story.md`.
