# Execution Brief — cs-163-creer-runtime-canonique-force-aspects

## Primary objective

Implement story `cs-163-creer-runtime-canonique-force-aspects` exactly as defined in `../00-story.md`.
