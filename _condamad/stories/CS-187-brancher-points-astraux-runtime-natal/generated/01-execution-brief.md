# Execution Brief — cs-187-brancher-points-astraux-runtime-natal

## Primary objective

Implement story `cs-187-brancher-points-astraux-runtime-natal` exactly as defined in `../00-story.md`.
