# Execution Brief — CS-425-invalider-regenerer-lectures-basic-natal-degradees

## Primary objective

Implement story `CS-425-invalider-regenerer-lectures-basic-natal-degradees` exactly as defined in `../00-story.md`.
