# Execution Brief — CS-338-cloturer-extinction-legacy-injection-llm-natale

## Primary objective

Implement story `CS-338-cloturer-extinction-legacy-injection-llm-natale` exactly as defined in `../00-story.md`.
