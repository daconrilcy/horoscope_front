# Execution Brief — story-cs-077-supprimer-redirects-legacy-admin-frontend-supprimer-les-redirects-legacy-admin-frontend

## Primary objective

Implement story `story-cs-077-supprimer-redirects-legacy-admin-frontend-supprimer-les-redirects-legacy-admin-frontend` exactly as defined in `../00-story.md`.
