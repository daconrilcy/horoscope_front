# Execution Brief — cs-066-migrer-cluster-coherent-valeurs-visuelles-hardcodees

## Primary objective

Implement story `cs-066-migrer-cluster-coherent-valeurs-visuelles-hardcodees` exactly as defined in `../00-story.md`.
