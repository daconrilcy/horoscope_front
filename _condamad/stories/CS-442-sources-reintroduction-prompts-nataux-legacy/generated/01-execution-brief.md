# Execution Brief — CS-442-sources-reintroduction-prompts-nataux-legacy

## Primary objective

Implement story `CS-442-sources-reintroduction-prompts-nataux-legacy` exactly as defined in `../00-story.md`.
