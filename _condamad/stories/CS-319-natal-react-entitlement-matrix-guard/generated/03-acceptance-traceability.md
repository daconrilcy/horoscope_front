...
| AC5 | Existing natal rendering tests still pass. | No natal rendering implementation files changed. | Targeted natal Vitest PASS and full `pnpm --dir frontend test` PASS, 116 files / 1277 passed / 8 skipped. | PASS |
