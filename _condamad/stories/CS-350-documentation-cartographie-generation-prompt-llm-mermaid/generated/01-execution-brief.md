# Execution Brief — cs-350-documentation-cartographie-generation-prompt-llm-mermaid

## Primary objective

Implement story `cs-350-documentation-cartographie-generation-prompt-llm-mermaid` exactly as defined in `../00-story.md`.
