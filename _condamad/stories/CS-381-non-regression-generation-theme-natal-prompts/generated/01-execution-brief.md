# Execution Brief — CS-381-non-regression-generation-theme-natal-prompts

## Primary objective

Implement story `CS-381-non-regression-generation-theme-natal-prompts` exactly as defined in `../00-story.md`.
