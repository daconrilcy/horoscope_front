# Execution Brief — CS-305-stabilize-frontend-full-vitest-suite-after-projection-wiring

## Primary objective

Implement story `CS-305-stabilize-frontend-full-vitest-suite-after-projection-wiring` exactly as defined in `../00-story.md`.
