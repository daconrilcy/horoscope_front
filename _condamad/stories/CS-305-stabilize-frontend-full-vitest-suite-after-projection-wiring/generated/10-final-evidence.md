...
| AC8 | Projection internals and touched inline-style guards clean. | Projection/internal scans PASS; touched TSX inline-style scan PASS. | PASS_WITH_LIMITATIONS |
| AC9 | Delivery report and CS-303 evidence addendum updated. | `evidence/report-status.md` records full-suite limitation removal and remaining browser/manual gap. | PASS |
...
| `rg -n "provider_response|raw_runtime|replay_snapshot|admin_answer_audit|expert_technical_projection_v1|astrology_full_data_v1" src` | `frontend` | PASS | No forbidden internal field exposure. |
