# Execution Brief — story-cs-059-retirer-selectors-legacy-aliases-compatibility-restants-retirer-les-selectors-legacy-et-aliases-compatibility-restants

## Primary objective

Implement story `story-cs-059-retirer-selectors-legacy-aliases-compatibility-restants-retirer-les-selectors-legacy-et-aliases-compatibility-restants` exactly as defined in `../00-story.md`.
