# Execution Brief — CS-364-definir-persistence-versionnee-contrats-prompt-theme-astral

## Primary objective

Implement story `CS-364-definir-persistence-versionnee-contrats-prompt-theme-astral` exactly as defined in `../00-story.md`.
