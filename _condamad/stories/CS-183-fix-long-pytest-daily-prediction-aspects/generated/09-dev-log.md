...
- Correction en cours sur les aspects daily et la projection publique.
...
- Implémentation: résolution d'orbes natals par paire de corps via règles ciblées puis orbe canonique `default_orb_deg`.
