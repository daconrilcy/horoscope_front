# Execution Brief — CS-429-theme-natal-generation-contracts-strict-schemas

## Primary objective

Implement story `CS-429-theme-natal-generation-contracts-strict-schemas` exactly as defined in `../00-story.md`.
