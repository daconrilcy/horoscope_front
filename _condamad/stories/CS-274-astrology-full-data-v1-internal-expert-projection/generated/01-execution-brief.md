# Execution Brief — CS-274-astrology-full-data-v1-internal-expert-projection

## Primary objective

Implement story `CS-274-astrology-full-data-v1-internal-expert-projection` exactly as defined in `../00-story.md`.
