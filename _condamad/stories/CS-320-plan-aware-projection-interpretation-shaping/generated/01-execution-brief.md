# Execution Brief — cs-320-plan-aware-projection-interpretation-shaping

## Primary objective

Implement story `cs-320-plan-aware-projection-interpretation-shaping` exactly as defined in `../00-story.md`.
