# Execution Brief — cs-178-documenter-zodiaque-ayanamsa-runtime

## Primary objective

Implement story `cs-178-documenter-zodiaque-ayanamsa-runtime` exactly as defined in `../00-story.md`.
