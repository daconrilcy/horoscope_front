# Execution Brief — cs-424-verifier-generation-prompts-basic-natal

## Primary objective

Implement story `cs-424-verifier-generation-prompts-basic-natal` exactly as defined in `../00-story.md`.
