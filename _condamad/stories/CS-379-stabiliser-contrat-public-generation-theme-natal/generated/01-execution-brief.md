# Execution Brief — CS-379-stabiliser-contrat-public-generation-theme-natal

## Primary objective

Implement story `CS-379-stabiliser-contrat-public-generation-theme-natal` exactly as defined in `../00-story.md`.
