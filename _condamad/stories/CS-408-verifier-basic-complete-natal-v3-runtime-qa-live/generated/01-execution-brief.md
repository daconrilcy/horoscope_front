# Execution Brief — CS-408-verifier-basic-complete-natal-v3-runtime-qa-live

## Primary objective

Implement story `CS-408-verifier-basic-complete-natal-v3-runtime-qa-live` exactly as defined in `../00-story.md`.
