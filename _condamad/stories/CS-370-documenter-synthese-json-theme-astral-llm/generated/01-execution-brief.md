# Execution Brief — cs-370-documenter-synthese-json-theme-astral-llm

## Primary objective

Implement story `cs-370-documenter-synthese-json-theme-astral-llm` exactly as defined in `../00-story.md`.
