...
| AC7 | Exposure classes are recorded. | Evidence and guard only. | `evidence/source-alignment.md`; guard test confirms `public`, `admin-only`, `test-only`, `bootstrap`, and `historical` tokens in the map. | PASS |
