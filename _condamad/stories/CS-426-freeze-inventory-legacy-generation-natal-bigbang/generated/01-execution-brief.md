# Execution Brief — CS-426-freeze-inventory-legacy-generation-natal-bigbang

## Primary objective

Implement story `CS-426-freeze-inventory-legacy-generation-natal-bigbang` exactly as defined in `../00-story.md`.
