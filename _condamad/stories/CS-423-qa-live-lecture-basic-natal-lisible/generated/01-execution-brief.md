# Execution Brief — CS-423-qa-live-lecture-basic-natal-lisible

## Primary objective

Implement story `CS-423-qa-live-lecture-basic-natal-lisible` exactly as defined in `../00-story.md`.
