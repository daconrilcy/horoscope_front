# Execution Brief — CS-291-generic-projection-endpoint-runtime

## Primary objective

Implement story `CS-291-generic-projection-endpoint-runtime` exactly as defined in `../00-story.md`.
