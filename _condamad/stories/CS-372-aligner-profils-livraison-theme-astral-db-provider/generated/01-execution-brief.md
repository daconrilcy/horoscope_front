# Execution Brief — cs-372-aligner-profils-livraison-theme-astral-db-provider

## Primary objective

Implement story `cs-372-aligner-profils-livraison-theme-astral-db-provider` exactly as defined in `../00-story.md`.
