# Execution Brief — CS-295-replay-snapshot-v1-storage-redaction

## Primary objective

Implement story `CS-295-replay-snapshot-v1-storage-redaction` exactly as defined in `../00-story.md`.
