# Execution Brief — CS-376-validation-provider-smoke-theme-astral

## Primary objective

Implement story `CS-376-validation-provider-smoke-theme-astral` exactly as defined in `../00-story.md`.
