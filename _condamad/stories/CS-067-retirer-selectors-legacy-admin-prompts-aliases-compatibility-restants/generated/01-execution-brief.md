# Execution Brief — cs-067-retirer-selectors-legacy-admin-prompts-aliases-compatibility-restants

## Primary objective

Implement story `cs-067-retirer-selectors-legacy-admin-prompts-aliases-compatibility-restants` exactly as defined in `../00-story.md`.
