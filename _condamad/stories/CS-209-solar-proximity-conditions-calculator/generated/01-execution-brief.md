# Execution Brief — cs-209-solar-proximity-conditions-calculator

## Primary objective

Implement story `cs-209-solar-proximity-conditions-calculator` exactly as defined in `../00-story.md`.
