# Execution Brief — cs-335-guards-non-invention-frontieres-payload-llm

## Primary objective

Implement story `cs-335-guards-non-invention-frontieres-payload-llm` exactly as defined in `../00-story.md`.
