# Execution Brief — CS-430-basic-full-reading-runtime-fake-provider

## Primary objective

Implement story `CS-430-basic-full-reading-runtime-fake-provider` exactly as defined in `../00-story.md`.
