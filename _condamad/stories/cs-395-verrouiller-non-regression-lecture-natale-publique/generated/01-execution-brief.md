# Execution Brief — cs-395-verrouiller-non-regression-lecture-natale-publique

## Primary objective

Implement story `cs-395-verrouiller-non-regression-lecture-natale-publique` exactly as defined in `../00-story.md`.
