# Execution Brief — CS-366-provider-payload-builder-theme-astral

## Primary objective

Implement story `CS-366-provider-payload-builder-theme-astral` exactly as defined in `../00-story.md`.
