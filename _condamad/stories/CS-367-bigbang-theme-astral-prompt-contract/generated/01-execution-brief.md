# Execution Brief — cs-367-bigbang-theme-astral-prompt-contract

## Primary objective

Implement story `cs-367-bigbang-theme-astral-prompt-contract` exactly as defined in `../00-story.md`.
