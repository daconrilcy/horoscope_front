# Execution Brief — CS-310-tests-manuels-profils-naissance-projections-natal

## Primary objective

Implement story `CS-310-tests-manuels-profils-naissance-projections-natal` exactly as defined in `../00-story.md`.
