# Execution Brief — cs-329-rapport-synthese-transition-injection-prompts-llm

## Primary objective

Implement story `cs-329-rapport-synthese-transition-injection-prompts-llm` exactly as defined in `../00-story.md`.
