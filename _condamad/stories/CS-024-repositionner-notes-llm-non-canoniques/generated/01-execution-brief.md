# Execution Brief — cs-024-repositionner-notes-llm-non-canoniques

## Primary objective

Implement story `cs-024-repositionner-notes-llm-non-canoniques` exactly as defined in `../00-story.md`.
