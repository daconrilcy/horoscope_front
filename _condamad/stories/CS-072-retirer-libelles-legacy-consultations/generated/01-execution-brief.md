# Execution Brief — cs-072-retirer-libelles-legacy-consultations

## Primary objective

Implement story `cs-072-retirer-libelles-legacy-consultations` exactly as defined in `../00-story.md`.
