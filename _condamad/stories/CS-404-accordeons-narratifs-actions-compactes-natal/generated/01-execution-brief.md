# Execution Brief — CS-404-accordeons-narratifs-actions-compactes-natal

## Primary objective

Implement story `CS-404-accordeons-narratifs-actions-compactes-natal` exactly as defined in `../00-story.md`.
