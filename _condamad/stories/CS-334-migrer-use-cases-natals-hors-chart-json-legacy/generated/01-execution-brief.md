# Execution Brief — cs-334-migrer-use-cases-natals-hors-chart-json-legacy

## Primary objective

Implement story `cs-334-migrer-use-cases-natals-hors-chart-json-legacy` exactly as defined in `../00-story.md`.
