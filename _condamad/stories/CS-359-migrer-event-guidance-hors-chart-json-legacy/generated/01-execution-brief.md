# Execution Brief — cs-359-migrer-event-guidance-hors-chart-json-legacy

## Primary objective

Implement story `cs-359-migrer-event-guidance-hors-chart-json-legacy` exactly as defined in `../00-story.md`.
