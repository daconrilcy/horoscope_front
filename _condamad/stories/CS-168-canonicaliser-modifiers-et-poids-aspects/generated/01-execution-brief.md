# Execution Brief — cs-168-canonicaliser-modifiers-et-poids-aspects

## Primary objective

Implement story `cs-168-canonicaliser-modifiers-et-poids-aspects` exactly as defined in `../00-story.md`.
