# Execution Brief — cs-406-router-basic-complete-assembly-natale-v3

## Primary objective

Implement story `cs-406-router-basic-complete-assembly-natale-v3` exactly as defined in `../00-story.md`.
