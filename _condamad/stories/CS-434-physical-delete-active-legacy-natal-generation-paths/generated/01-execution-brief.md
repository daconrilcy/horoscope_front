# Execution Brief — cs-434-physical-delete-active-legacy-natal-generation-paths

## Primary objective

Implement story `cs-434-physical-delete-active-legacy-natal-generation-paths` exactly as defined in `../00-story.md`.
