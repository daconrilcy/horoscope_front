...
| `backend/app/tests/unit/test_natal_cross_tool_report_dev_script.py` | scripts | Backend quality suite registry | `pytest -q app/tests/unit/test_natal_cross_tool_report_dev_script.py` | none | subprocess via current Python interpreter | standard_backend_pytest |
...
| `backend/tests/unit/test_replay_snapshot_v1_storage_security_model.py` | security | Security quality suite registry | `pytest -q tests/unit/test_replay_snapshot_v1_storage_security_model.py` | none | none | standard_backend_pytest |
