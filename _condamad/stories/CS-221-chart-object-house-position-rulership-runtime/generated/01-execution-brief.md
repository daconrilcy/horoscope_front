# Execution Brief — cs-221-chart-object-house-position-rulership-runtime

## Primary objective

Implement story `cs-221-chart-object-house-position-rulership-runtime` exactly as defined in `../00-story.md`.
