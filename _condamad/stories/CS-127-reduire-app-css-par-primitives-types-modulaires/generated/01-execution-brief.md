# Execution Brief — cs-127-reduire-app-css-par-primitives-types-modulaires

## Primary objective

Implement story `cs-127-reduire-app-css-par-primitives-types-modulaires` exactly as defined in `../00-story.md`.
