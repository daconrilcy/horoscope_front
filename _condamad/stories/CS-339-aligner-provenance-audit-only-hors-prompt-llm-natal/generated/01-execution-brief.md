# Execution Brief — CS-339-aligner-provenance-audit-only-hors-prompt-llm-natal

## Primary objective

Implement story `CS-339-aligner-provenance-audit-only-hors-prompt-llm-natal` exactly as defined in `../00-story.md`.
