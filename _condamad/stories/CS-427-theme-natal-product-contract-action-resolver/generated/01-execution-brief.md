# Execution Brief — CS-427-theme-natal-product-contract-action-resolver

## Primary objective

Implement story `CS-427-theme-natal-product-contract-action-resolver` exactly as defined in `../00-story.md`.
