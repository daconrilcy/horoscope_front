# Execution Brief — cs-332-llm-astrology-input-v1-natal-runtime

## Primary objective

Implement story `cs-332-llm-astrology-input-v1-natal-runtime` exactly as defined in `../00-story.md`.
