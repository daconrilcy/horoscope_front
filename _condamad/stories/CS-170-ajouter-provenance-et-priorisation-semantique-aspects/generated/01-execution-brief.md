# Execution Brief — cs-170-ajouter-provenance-et-priorisation-semantique-aspects

## Primary objective

Implement story `cs-170-ajouter-provenance-et-priorisation-semantique-aspects` exactly as defined in `../00-story.md`.
