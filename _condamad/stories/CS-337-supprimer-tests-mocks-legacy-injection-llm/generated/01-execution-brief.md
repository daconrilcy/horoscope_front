# Execution Brief — cs-337-supprimer-tests-mocks-legacy-injection-llm

## Primary objective

Implement story `cs-337-supprimer-tests-mocks-legacy-injection-llm` exactly as defined in `../00-story.md`.
