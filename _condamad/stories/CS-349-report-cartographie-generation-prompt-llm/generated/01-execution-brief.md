# Execution Brief — CS-349-report-cartographie-generation-prompt-llm

## Primary objective

Implement story `CS-349-report-cartographie-generation-prompt-llm` exactly as defined in `../00-story.md`.
