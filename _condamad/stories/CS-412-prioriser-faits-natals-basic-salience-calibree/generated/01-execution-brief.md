# Execution Brief — CS-412-prioriser-faits-natals-basic-salience-calibree

## Primary objective

Implement story `CS-412-prioriser-faits-natals-basic-salience-calibree` exactly as defined in `../00-story.md`.
