# Execution Brief — CS-307-audit-ux-natal-apres-wiring-projections

## Primary objective

Implement story `CS-307-audit-ux-natal-apres-wiring-projections` exactly as defined in `../00-story.md`.
