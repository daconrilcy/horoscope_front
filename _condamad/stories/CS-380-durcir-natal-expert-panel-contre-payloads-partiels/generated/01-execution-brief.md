# Execution Brief — cs-380-durcir-natal-expert-panel-contre-payloads-partiels

## Primary objective

Implement story `cs-380-durcir-natal-expert-panel-contre-payloads-partiels` exactly as defined in `../00-story.md`.
