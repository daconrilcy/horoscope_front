# Execution Brief — CS-422-simplifier-rendu-basic-natal-sources-mentions-legales

## Primary objective

Implement story `CS-422-simplifier-rendu-basic-natal-sources-mentions-legales` exactly as defined in `../00-story.md`.
