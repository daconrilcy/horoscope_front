# Execution Brief — cs-070-retirer-vocabulaire-legacy-admin-prompts-runtime

## Primary objective

Implement story `cs-070-retirer-vocabulaire-legacy-admin-prompts-runtime` exactly as defined in `../00-story.md`.
