...
- `backend/app/domain/prediction/**`: no LLM/editorial coupling in semantic facts.
- `backend/app/services/**`: no service orchestration needed for pure semantic contracts.
