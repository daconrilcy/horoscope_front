# Execution Brief — cs-167-separer-semantique-et-editorial-aspects

## Primary objective

Implement story `cs-167-separer-semantique-et-editorial-aspects` exactly as defined in `../00-story.md`.
