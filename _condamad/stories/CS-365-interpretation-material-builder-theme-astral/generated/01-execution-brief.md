# Execution Brief — cs-365-interpretation-material-builder-theme-astral

## Primary objective

Implement story `cs-365-interpretation-material-builder-theme-astral` exactly as defined in `../00-story.md`.
