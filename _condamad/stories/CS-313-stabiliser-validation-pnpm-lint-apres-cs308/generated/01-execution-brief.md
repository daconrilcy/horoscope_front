# Execution Brief — cs-313-stabiliser-validation-pnpm-lint-apres-cs308

## Primary objective

Implement story `cs-313-stabiliser-validation-pnpm-lint-apres-cs308` exactly as defined in `../00-story.md`.
