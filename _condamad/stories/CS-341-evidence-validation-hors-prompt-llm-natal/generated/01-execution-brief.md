# Execution Brief — cs-341-evidence-validation-hors-prompt-llm-natal

## Primary objective

Implement story `cs-341-evidence-validation-hors-prompt-llm-natal` exactly as defined in `../00-story.md`.
