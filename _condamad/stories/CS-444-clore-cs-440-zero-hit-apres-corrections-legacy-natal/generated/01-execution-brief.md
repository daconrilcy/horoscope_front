# Execution Brief — CS-444-clore-cs-440-zero-hit-apres-corrections-legacy-natal

## Primary objective

Implement story `CS-444-clore-cs-440-zero-hit-apres-corrections-legacy-natal` exactly as defined in `../00-story.md`.
