...
| AC8 | CS-440 report claims full closure only. | Existing report contains full closure claims and no partial/blocker wording in scoped scan. | Report checks PASS. | PASS |
...
| AC11 | CS-440 tracker status changes after proof. | `story-status.md` marks CS-440 `done`; CS-444 is `ready-to-review`. | Tracker row check PASS. | PASS |
