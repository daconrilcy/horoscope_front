# Execution Brief — cs-373-structurer-birth-context-theme-astral-llm-input

## Primary objective

Implement story `cs-373-structurer-birth-context-theme-astral-llm-input` exactly as defined in `../00-story.md`.
