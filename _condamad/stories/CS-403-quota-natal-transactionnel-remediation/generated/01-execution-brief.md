# Execution Brief — CS-403-quota-natal-transactionnel-remediation

## Primary objective

Implement story `CS-403-quota-natal-transactionnel-remediation` exactly as defined in `../00-story.md`.
