# Execution Brief — CS-284-astrology-disclaimer-projection-policy

## Primary objective

Implement story `CS-284-astrology-disclaimer-projection-policy` exactly as defined in `../00-story.md`.
