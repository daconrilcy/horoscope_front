# Execution Brief — cs-172-big-bang-reference-runtime-astrology

## Primary objective

Implement story `cs-172-big-bang-reference-runtime-astrology` exactly as defined in `../00-story.md`.
