# Execution Brief — CS-441-suppression-runtime-generate-natal-legacy

## Primary objective

Implement story `CS-441-suppression-runtime-generate-natal-legacy` exactly as defined in `../00-story.md`.
