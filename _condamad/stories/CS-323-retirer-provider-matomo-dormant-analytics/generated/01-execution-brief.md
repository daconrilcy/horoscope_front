# Execution Brief — CS-323-retirer-provider-matomo-dormant-analytics

## Primary objective

Implement story `CS-323-retirer-provider-matomo-dormant-analytics` exactly as defined in `../00-story.md`.
