# Execution Brief — CS-358-generer-exemples-json-prompts-theme-astral-par-plan

## Primary objective

Implement story `CS-358-generer-exemples-json-prompts-theme-astral-par-plan` exactly as defined in `../00-story.md`.
