...
| AC13 | Each content section names evidence. | `supporting_evidence_ids` generated as opaque public IDs from required facts. | `test_public_evidence_is_user_readable_and_linked_to_sections`; `test_public_evidence_ids_are_opaque_and_do_not_reuse_fact_ids` | PASS |
...
| AC15 | Public evidence is user-readable. | `BasicNatalPublicEvidence` label/explanation mapper with opaque IDs. | `test_public_evidence_is_user_readable_and_linked_to_sections`; `test_public_evidence_ids_are_opaque_and_do_not_reuse_fact_ids` | PASS |
...
| AC23 | Technical internals stay non-public. | Public evidence mapper omits scores, source paths, prompt hints and raw fact IDs. | `test_public_evidence_does_not_expose_internal_scoring_or_prompt_hints`; `test_public_evidence_ids_are_opaque_and_do_not_reuse_fact_ids`; negative `rg` | PASS |
