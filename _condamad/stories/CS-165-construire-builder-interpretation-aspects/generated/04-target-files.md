...
- `backend/tests/unit/domain/astrology/test_aspect_interpretation_builder.py`

## Forbidden or high-risk files

- `backend/app/domain/prediction/**`: prediction/editorial orchestration remains separate.
- `backend/app/api/**`: no endpoint contract change in this story.
- `frontend/**`: story is domain builder scoped.
