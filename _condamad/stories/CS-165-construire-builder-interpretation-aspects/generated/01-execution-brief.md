# Execution Brief — cs-165-construire-builder-interpretation-aspects

## Primary objective

Implement story `cs-165-construire-builder-interpretation-aspects` exactly as defined in `../00-story.md`.
