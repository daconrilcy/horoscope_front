...
| F-004 | Medium | Medium | Semantic grounding architecture/reporting | Medium if schema-valid output is described as semantically proven | Deferred to CS-348/CS-350 documentation | P2 |
