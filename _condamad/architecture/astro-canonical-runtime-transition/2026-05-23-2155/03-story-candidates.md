...
All candidates use `Story ID: needs-tracker-remap` because CS-237 to CS-245 are allocated and CS-242 explicitly reports source-label conflicts for CS-243, CS-244 and CS-245. No implementation story should be generated from this file until `_condamad/stories/story-status.md` assigns concrete new IDs.

## SC-ARCH-001 - Define canonical astrology graph family registry
...
## SC-ARCH-002 - Add graph manifest and node IO schema contract for canonical runtime
...
## SC-ARCH-003 - Add calculation graph execution trace contract
...
## SC-ARCH-004 - Define chart object capability and object taxonomy matrix
...
## SC-ARCH-005 - Define official product primitives and public projection roadmap
...
## SC-ARCH-006 - Select first temporal technique implementation path
...
## SC-ARCH-006A - Harden astronomical proof before public temporal runtime

- Story ID: needs-tracker-remap
- Source findings: CS-241 F-001..F-004; CS-242 F-005
- Source labels: CS-241 SC-001..SC-004
- Priority: P1, before temporal runtime implementation
...
## SC-ARCH-007 - Define astrology doctrine and school governance model
...
## SC-ARCH-008 - Define AI scoring and narrative input contract from canonical runtime
