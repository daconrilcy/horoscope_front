...
Règles métier:
- Si la question est prédictive ("vais-je..."), reformule en tendances + fenêtre plausible + leviers concrets, sans certitude absolue.
...
def seed() -> None:
    ...
    try:
        ...
        new_prompt = LlmPromptVersionModel(
            ...
            model="gpt-4o-mini",
            temperature=0.5,  # Réduit à 0.5 (vs 0.7 par défaut) pour des réponses plus cohérentes et moins verboses
