...
def _default_dominance_factor_types(reference_version: str) -> tuple[dict[str, object], ...]:
    ...
    return (
        ...
        },
        {
            ...
            "sort_order": 20,
            "is_active": True,
            "description": "Angular placement factor.",
            "reference_version": reference_version,
        },
        {
            ...
            "sort_order": 30,
            "is_active": True,
            "description": "Functional strength factor.",
            "reference_version": reference_version,
        },
        {
            "code": "visibility",
        ...
        },
        {
            ...
            "sort_order": 50,
            "is_active": True,
            "description": "Most elevated planet factor.",
            "reference_version": reference_version,
        },
        {
        ...
        },
        {
            ...
            "sort_order": 70,
            "is_active": True,
            "description": "House rulership load factor.",
            "reference_version": reference_version,
        },
        {
            ...
            "sort_order": 80,
            "is_active": True,
            "description": "Aspect centrality factor.",
            "reference_version": reference_version,
        },
    )
