...
def test_scenario_polarized_day():
    ...
    data["category_scores"] = [
        PersistedCategoryScore(
            category_id=1, category_code="work", note_20=18, raw_score=1.0, 
            power=1.0, volatility=0.0, rank=1, is_provisional=False, summary="H",
            score_20=18.0
        ),
        PersistedCategoryScore(
            category_id=2, category_code="energy", note_20=4, raw_score=0.1, 
            power=0.1, volatility=0.0, rank=2, is_provisional=False, summary="L",
            score_20=4.0
        )
    ]
