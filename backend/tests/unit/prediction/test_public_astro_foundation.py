...
def test_astro_foundation_key_movements_limit():
    ...
    result = policy.build(MagicMock(), day_climate=day_climate, domain_ranking=[], evidence=evidence)
...
def test_astro_foundation_activated_houses():
    ...
    day_climate = {"label": "Stable"}
    result = policy.build(MagicMock(), day_climate=day_climate, domain_ranking=domain_ranking, evidence=evidence)
