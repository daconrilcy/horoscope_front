...
from app.domain.astrology.calculators.aspects import calculate_interchart_aspects
...
def test_interchart_aspects_reuse_existing_aspect_definitions() -> None:
    ...
    source_positions = [{"planet_code": "sun", "longitude": 0.0}]
    target_positions = [{"planet_code": "moon", "longitude": 120.2}]
    definitions = [{"code": "trine", "angle": 120.0, "default_orb_deg": 6.0}]

    aspects = calculate_interchart_aspects(source_positions, target_positions, definitions)
...
def test_interchart_aspects_apply_targeted_orb_rules_to_original_body_codes() -> None:
    ...
    source_positions = [{"planet_code": "sun", "longitude": 0.0}]
    target_positions = [{"planet_code": "moon", "longitude": 127.0}]
    definitions = [{"code": "trine", "angle": 120.0, "default_orb_deg": 3.0}]
    orb_rules = [
        {
            "system_code": "modern",
            "aspect_code": "trine",
