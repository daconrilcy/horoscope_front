"""Déclare les erreurs runtime canoniques partagées par les composants LLM."""

from __future__ import annotations


class AIEngineError(Exception):
    """Erreur racine normalisée du runtime LLM."""
    ...
    def to_dict(self) -> dict[str, object]:
        """Convertit l’erreur en structure sérialisable pour l’API."""
...
class ValidationError(AIEngineError):
    """Signale une validation de requête invalide."""
...
class UnknownUseCaseError(AIEngineError):
    """Signale l’appel à un use case inconnu."""
...
class ContextTooLargeError(AIEngineError):
    """Signale un contexte trop volumineux pour les garde-fous runtime."""
