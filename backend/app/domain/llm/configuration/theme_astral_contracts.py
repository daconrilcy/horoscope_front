...
THEME_ASTRAL_DELIVERY_PROFILES: dict[str, dict[str, Any]] = {
    "essential": {
        ...
        "profile_id": "theme_astral_delivery_profile_v1",
        "depth": "essential",
    ...
    "complete": {
        ...
        "profile_id": "theme_astral_delivery_profile_v1",
        "depth": "complete",
        "selection_policy": "complete_chart_factors",
                ...
                "input_data": {
                    "oneOf": [
                        ...
                        },
                        {
                            "type": "object",
                            "additionalProperties": False,
                            "required": ["basic_natal_prompt_payload"],
                            "properties": {
                                "basic_natal_prompt_payload": {
                                    ...
                                    "properties": {
                                        "sections": {"type": "array"},
                                        "resolved_syntheses": {"type": "array"},
                                        "editorial_evidence": {"type": "array"},
