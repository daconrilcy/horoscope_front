...
from app.infra.llm.rate_limiter import (
    MemoryRateLimiter,
    RateLimiter,
    RateLimitResult,
    RedisRateLimiter,
...
class TestMemoryRateLimiter:
    ...
    def test_window_resets_after_time(self) -> None:
        ...
        with patch("app.infra.llm.rate_limiter.time") as mock_time:
...
class TestRateLimiter:
    ...
    def test_get_instance_singleton(self) -> None:
        ...
        with patch("app.core.llm_settings.ai_engine_settings") as mock_settings:
