...
APPROVED_CREATE_ALL_PATHS = {
    ...
    Path("app/tests/integration/test_admin_chart_diagnostics_api.py"),
    ...
    Path("app/tests/integration/test_reference_languages_api.py"),
    ...
    Path("tests/api/admin/test_rejected_answer_review_workflow.py"),
    ...
    Path("tests/integration/test_replay_snapshot_v1_service_non_cascade.py"),
    Path("tests/integration/test_replay_snapshot_v1_service_purge.py"),
    ...
    Path("tests/unit/projections/test_projection_access.py"),
    Path("tests/unit/projections/test_projection_builder_gate.py"),
    Path("tests/unit/projections/test_projection_persistence.py"),
    Path("tests/unit/test_replay_snapshot_v1_purge.py"),
    Path("tests/unit/test_replay_snapshot_v1_retention.py"),
    Path("tests/unit/test_replay_snapshot_v1_execution_audit.py"),
    Path("tests/unit/test_replay_snapshot_v1_service_audit.py"),
