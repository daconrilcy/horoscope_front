...
def create_mock_cat_dict(note_20, intensity_20, stability_day):
    return {"note_20": note_20, "intensity_20": intensity_20, "stability_day": stability_day}
...
def test_is_flat_day_true_flat():
    ...
    categories = [create_mock_cat_dict(10.0, 1.0, 14.0), create_mock_cat_dict(10.0, 0.5, 19.0)]
...
def test_is_flat_day_intense_neutral():
    ...
    categories = [create_mock_cat_dict(10.0, 8.0, 5.0), create_mock_cat_dict(10.0, 1.0, 18.0)]
...
def test_is_flat_day_weak_not_flat():
    ...
    categories = [create_mock_cat_dict(10.0, 4.0, 15.0), create_mock_cat_dict(10.0, 1.0, 18.0)]
...
def test_is_flat_day_fallback_v2():
    ...
    categories = [create_mock_cat_dict(10.0, None, None), create_mock_cat_dict(10.0, None, None)]
