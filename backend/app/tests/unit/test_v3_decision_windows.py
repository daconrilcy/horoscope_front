...
def test_build_v3_prudence_window():
    ...
    # Falling block
    blocks = [
        V3TimeBlock(0, start, start + timedelta(hours=2), "falling", 8.0, 0.8, ["money"])
    ]
...
def test_build_v3_confidence_filter():
    ...
    blocks = [
        V3TimeBlock(0, start, start + timedelta(hours=2), "rising", 10.0, 0.2, ["work"])
    ]
...
def test_build_v3_pivot_window():
    ...
    pivots = [
        V3TurningPoint(pivot_time, "regime_change", 5.0, 120, 0.8, ["work"])
    ]
...
def test_build_v3_score_blending():
    ...
    blocks = [
        V3TimeBlock(0, start, start + timedelta(hours=2), "rising", 10.0, 0.8, ["work"])
    ]
