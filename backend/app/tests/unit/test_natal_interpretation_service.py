...
class TestBuildNatalChartSummary:
    ...
    def _french_labels(self) -> AstrologyLabels:
        """Construit les libellés de signes utilisés par les tests historiques."""
