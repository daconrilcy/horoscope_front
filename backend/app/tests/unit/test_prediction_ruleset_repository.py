...
def test_get_parameters(db_session: Session):
    ...
    params = [
        RulesetParameterModel(
            ruleset_id=ruleset.id, param_key="f_val", param_value="1.5", data_type="float"
        ),
        RulesetParameterModel(
            ruleset_id=ruleset.id, param_key="i_val", param_value="42", data_type="int"
        ),
        RulesetParameterModel(
            ruleset_id=ruleset.id, param_key="b_val", param_value="true", data_type="bool"
        ),
        RulesetParameterModel(
            ruleset_id=ruleset.id, param_key="j_val", param_value='{"a": 1}', data_type="json"
        ),
        RulesetParameterModel(
            ruleset_id=ruleset.id, param_key="s_val", param_value="hello", data_type="string"
        ),
    ]
