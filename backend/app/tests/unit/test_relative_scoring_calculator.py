...
def test_calculate_nominal_z_score():
    ...
    baselines = {
        "love": PersistedUserBaseline(
            id=1, user_id=1, category_id=1, category_code="love",
            ...
            mean_raw_score=10.0, std_raw_score=2.0,
...
def test_calculate_null_variance_fallback():
    ...
    baselines = {
        "love": PersistedUserBaseline(
            ...
            reference_version_id=1, ruleset_id=1, house_system_effective="placidus",
            window_days=365, window_start_date=None, window_end_date=None,
            mean_raw_score=10.0, std_raw_score=0.0,  # NULL VARIANCE
            mean_note_20=12.0, std_note_20=1.0,
            p10=7.0, p50=10.0, p90=13.0,
            sample_size_days=365, computed_at=datetime.now()
        )
...
def test_calculate_ranking():
    ...
    baselines = {
        "love": PersistedUserBaseline(
            ...
            reference_version_id=1, ruleset_id=1, house_system_effective="placidus",
            window_days=365, window_start_date=None, window_end_date=None,
            mean_raw_score=10.0, std_raw_score=5.0,  # Z = 1.0
            mean_note_20=12.0, std_note_20=1.0,
            p10=7.0, p50=10.0, p90=13.0,
            sample_size_days=365, computed_at=datetime.now()
        ),
        "work": PersistedUserBaseline(
            id=1, user_id=1, category_id=2, category_code="work",
            reference_version_id=1, ruleset_id=1, house_system_effective="placidus",
            window_days=365, window_start_date=None, window_end_date=None,
            mean_raw_score=5.0, std_raw_score=1.0,  # Z = 7.0
            mean_note_20=12.0, std_note_20=1.0,
            p10=3.0, p50=5.0, p90=7.0,
            sample_size_days=365, computed_at=datetime.now()
        )
    }
...
def test_calculate_ranking_uses_alphabetical_tie_break():
    ...
    baselines = {
        "love": PersistedUserBaseline(
            ...
            reference_version_id=1, ruleset_id=1, house_system_effective="placidus",
            window_days=365, window_start_date=None, window_end_date=None,
            mean_raw_score=6.0, std_raw_score=2.0,
            mean_note_20=12.0, std_note_20=1.0,
            p10=4.0, p50=6.0, p90=8.0,
            sample_size_days=365, computed_at=datetime.now()
        ),
        "work": PersistedUserBaseline(
            id=2, user_id=1, category_id=2, category_code="work",
            reference_version_id=1, ruleset_id=1, house_system_effective="placidus",
            window_days=365, window_start_date=None, window_end_date=None,
            mean_raw_score=6.0, std_raw_score=2.0,
            mean_note_20=12.0, std_note_20=1.0,
