"""Service de seed QA canonique pour les parcours internes de generation LLM."""
...
class LlmQaSeedServiceError(Exception):
    """Erreur explicite du seed QA canonique."""
...
class LlmQaSeedService:
    ...
    def environment_allows_seed() -> bool:
        """Indique si le seed QA est autorise dans l environnement courant."""
    ...
    def ensure_canonical_test_user(db: Session) -> LlmQaSeedResult:
        """Garantit la presence de l utilisateur QA canonique et de son chart."""
