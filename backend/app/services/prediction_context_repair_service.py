...
class PredictionContextRepairService:
    """
    Service responsible for repairing missing or locked prediction context data.
    Decouples maintenance logic from the main prediction flow.
    """
    ...
    def try_repair(
        ...
        """
        Attempts to repair the context if it's eligible for auto-seeding.
        AC3 Compliance: Explicit logging and idempotence.
        """
