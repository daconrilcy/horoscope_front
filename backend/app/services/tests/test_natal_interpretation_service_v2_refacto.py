...
from app.llm_orchestration.models import NatalExecutionInput, GatewayResult, UsageInfo, GatewayMeta
...
async def test_interpret_calls_adapter_canonical(db):
    ...
    with patch("app.services.ai_engine_adapter.AIEngineAdapter.generate_natal_interpretation", new_callable=AsyncMock) as mock_gen:
        ...
        # Mock dependencies
        with patch("app.services.natal_interpretation_service_v2.build_chart_json") as mock_chart, \
             patch("app.services.natal_interpretation_service_v2.build_enriched_evidence_catalog") as mock_catalog:
