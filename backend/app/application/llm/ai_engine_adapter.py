"""
Couche applicative canonique LLM (story 70-15).

Point d'entrée unique pour les services métier (Chat, Guidance, Natal, narration)
souhaitant exécuter un appel LLM orchestré.
