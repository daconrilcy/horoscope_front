...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_flagged_contents_reported_at"), "flagged_contents", ["reported_at"], unique=False
    )
    op.create_index(
        op.f("ix_flagged_contents_status"), "flagged_contents", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_flagged_contents_user_id"), "flagged_contents", ["user_id"], unique=False
    )
