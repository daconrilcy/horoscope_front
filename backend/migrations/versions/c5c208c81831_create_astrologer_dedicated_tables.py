...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_astrologer_profiles_is_public"), "astrologer_profiles", ["is_public"], unique=False
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_astrologer_prompt_profiles_persona_id"), table_name="astrologer_prompt_profiles"
    )
    op.drop_index(
        op.f("ix_astrologer_prompt_profiles_is_active"), table_name="astrologer_prompt_profiles"
    )
    op.drop_table("astrologer_prompt_profiles")
    op.drop_index(op.f("ix_astrologer_profiles_is_public"), table_name="astrologer_profiles")
    op.drop_index(op.f("ix_astrologer_profiles_admin_category"), table_name="astrologer_profiles")
