...
def upgrade():
    ...
    op.create_index(op.f('ix_canonical_entitlement_mutation_alert_events_audit_id'), 'canonical_entitlement_mutation_alert_events', ['audit_id'], unique=False)
    op.create_index(op.f('ix_canonical_entitlement_mutation_alert_events_created_at'), 'canonical_entitlement_mutation_alert_events', ['created_at'], unique=False)


def downgrade():
    op.drop_index(op.f('ix_canonical_entitlement_mutation_alert_events_created_at'), table_name='canonical_entitlement_mutation_alert_events')
    op.drop_index(op.f('ix_canonical_entitlement_mutation_alert_events_audit_id'), table_name='canonical_entitlement_mutation_alert_events')
