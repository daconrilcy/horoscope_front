...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_stripe_billing_profiles_user_id", "stripe_billing_profiles", ["user_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_stripe_billing_profiles_user_id", table_name="stripe_billing_profiles")
    op.drop_index(
        "ix_stripe_billing_profiles_last_stripe_event_id", table_name="stripe_billing_profiles"
    )
    op.drop_index(
        "ix_stripe_billing_profiles_stripe_subscription_id", table_name="stripe_billing_profiles"
    )
    op.drop_index(
        "ix_stripe_billing_profiles_stripe_customer_id", table_name="stripe_billing_profiles"
    )
