...
/**
 * Détecte le fuseau horaire de l'utilisateur via l'API Intl du navigateur.
 * @returns Fuseau horaire IANA détecté s'il est dans la liste TIMEZONES, sinon "UTC"
 * @note Retourne "UTC" si la détection échoue ou si le fuseau détecté n'est pas standard
 */
