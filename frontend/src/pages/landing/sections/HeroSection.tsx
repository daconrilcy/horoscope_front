    ...
    <section className="hero-section" aria-labelledby="hero-title">
      <div className="hero-content">
        ...
        <div className="hero-ctas">
          ...
          >
            {t.hero.ctaPrimary}
            <ArrowRight size={20} className="hero-cta-icon-right" aria-hidden="true" />
          </Button>
          ...
          >
            <Play size={18} className="hero-cta-icon-left hero-cta-icon--fill" aria-hidden="true" />
            {t.hero.ctaSecondary}
          </a>
          </div>
          ...
          />
          <p className="hero-visual-text">{t.hero.imageAlt}</p>
          </div>
