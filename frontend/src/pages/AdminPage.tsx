...
function EntitlementsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
function SupportIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 11-7.6-10.6 8.5 8.5 0 013 1.5" /><path d="M16.1 10.1l-3.9 3.9L10 11.8" />
    </svg>
  )
}
...
export function AdminPage() {
  ...
  const adminSections: AdminSection[] = [
    ...
    { path: "/admin/support", label: tSections.support, Icon: SupportIcon },
    { path: "/admin/settings", label: tSections.settings, Icon: SettingsIcon },
  ]
  ...
  return (
    <AdminPermissionsProvider>
      ...
      >
        <Outlet context={{ sections: adminSections }} />
      </AdminLayout>
    </AdminPermissionsProvider>
  )
}
