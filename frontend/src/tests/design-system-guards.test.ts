...
describe("design-system guards", () => {
  ...
  it("garde le relief compact et le contrat catalogue CS-148 de la liste astrologues", () => {
    ...
    const tabletGridBlock = findFlatCssBlock(appCss, "@media (min-width: 700px)")
    const desktopGridBlock = findFlatCssBlock(appCss, "@media (min-width: 1180px)")
    ...
    const ctaActionsBlock = findFlatCssBlock(appCss, ".people-page .person-card-actions")
    const ctaButtonBlock = findFlatCssBlock(appCss, ".people-page .person-card-primary-cta,\n.people-page .person-card-secondary-cta")
    ...
    expect(gridBlock.body).toContain("grid-template-columns: minmax(0, 1fr)")
    expect(tabletGridBlock.body).toContain("grid-template-columns: repeat(2, minmax(0, 1fr))")
    expect(desktopGridBlock.body).toContain("grid-template-columns: repeat(3, minmax(0, 1fr))")
    ...
    expect(iconBlock.body).toContain("position: relative")
    expect(iconBlock.body).toContain("flex: 0 0 auto")
    ...
    expect(ctaActionsBlock.body).toContain("margin-top: auto")
    expect(ctaActionsBlock.body).toContain("width: 100%")
    expect(ctaButtonBlock.body).toContain("display: flex")
    expect(ctaButtonBlock.body).toContain("width: 100%")
