...
describe("design-system guards", () => {
  ...
  it("garde le relief compact et le contrat catalogue CS-148 de la liste astrologues", () => {
    ...
    expect(gridBlock.body).toContain("repeat(auto-fit, minmax(min(100%, 340px), 1fr))")
    ...
    expect(ctaBlock.body).toContain("display: flex")
    expect(ctaBlock.body).toContain("width: 100%")
    expect(ctaBlock.body).toContain("text-decoration: none")
