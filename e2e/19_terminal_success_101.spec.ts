...
// E2E: Dev Terminal success amount 1.01€ (101)
test.describe('Dev Terminal (success 1.01€)', () => {
  test('process succeeds and shows captured (101)', async ({
    page,
    baseURL,
  }) => {
    ...
    // Sélectionner montant 1.01€ (101) avant de créer l'intent
    await page.getByLabel('Montant (centimes):').selectOption('101');
